...
const projects = [
  {
    ...
    description: "A full-stack e-commerce solution with Next.js, Stripe integration, and admin dashboard.",
    images: [
      "/placeholder.svg?height=200&width=300&text=E-Commerce+Home",
      "/placeholder.svg?height=200&width=300&text=Product+Page",
      "/placeholder.svg?height=200&width=300&text=Shopping+Cart",
      "/placeholder.svg?height=200&width=300&text=Admin+Dashboard",
    ],
  ...
  },
  {
    ...
    description: "AI-powered content generation tool using OpenAI API with custom prompts and templates.",
    images: [
...
const experiences = [
  ...
  },
  {
    ...
    period: "2020 - 2022",
    description:
      "Developed responsive web applications and collaborated with design team to create intuitive user interfaces. Reduced load times by 60%.",
  ...
  },
  {
    ...
    period: "2019 - 2020",
    description:
      "Built and maintained client websites, learned modern development practices, and contributed to team projects.",
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-800">
      ...
      <section id="about" className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <motion.div initial="initial" whileInView="animate" viewport={{ once: true }} variants={staggerContainer}>
            <motion.h2 className="text-4xl font-bold text-center mb-16" variants={fadeInUp}>
              About Me
            </motion.h2>

            <div className="grid md:grid-cols-2 gap-12 items-center">
              <motion.div variants={fadeInUp}>
                <h3 className="text-2xl font-semibold mb-6">Hello! I'm John Doe</h3>
      ...
      <section id="contact" className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div initial="initial" whileInView="animate" viewport={{ once: true }} variants={staggerContainer}>
            ...
            <motion.p className="text-xl text-muted-foreground mb-12" variants={fadeInUp}>
      ...
      <footer className="py-8 px-4 border-t bg-muted/30">
        <div className="max-w-6xl mx-auto text-center">
          <p className="text-muted-foreground">© 2024 John Doe. Built with Next.js, Tailwind CSS, and lots of ☕</p>
        </div>
      </footer>
    </div>
  )
